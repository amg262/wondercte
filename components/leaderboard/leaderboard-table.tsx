...
import { NflBadge } from "@/components/nfl/nfl-badge";
            ...
            >
              ...
              <div className="flex items-start gap-6">
                <div className="text-right">
                  ...
                  {entry.nflPlayerName && entry.nflPlayerPosition && (
                    <div className="mt-1">
                      <NflBadge
                        playerName={entry.nflPlayerName}
                        position={entry.nflPlayerPosition}
                      />
                    </div>
                  )}
                </div>
